var size = 0;
var ranges_Housing_Train = [[22.043853, 364.627970, [ new ol.style.Style({
...
[364.627970, 636.649144, [ new ol.style.Style({
        image: new ol.style.Circle({radius: 6.0 + size,
...
[636.649144, 969.483383, [ new ol.style.Style({
        image: new ol.style.Circle({radius: 6.0 + size,
...
[969.483383, 1431.862309, [ new ol.style.Style({
        image: new ol.style.Circle({radius: 6.0 + size,
...
[1431.862309, 3491.508685, [ new ol.style.Style({
        image: new ol.style.Circle({radius: 6.0 + size,
...
var styleCache_Housing_Train={}
var style_Housing_Train = function(feature, resolution){
    var value = feature.get("Housing__1");
    var style = ranges_Housing_Train[0][2];
    for (i = 0; i < ranges_Housing_Train.length; i++){
        var range = ranges_Housing_Train[i];
    ...
    if (!styleCache_Housing_Train[key]){
        ...
        styleCache_Housing_Train[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_Housing_Train[key]];
